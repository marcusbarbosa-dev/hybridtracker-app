...
const movements: Movement[] = [
  ...
  { id: 'sled-push', name: 'Empurrar trenó', category: 'Estação', equipment: 'Trenó e pista', level: 'Intermediário', objective: 'Produzir força horizontal mantendo deslocamento consistente.', steps: ['Apoie as mãos e incline o corpo em bloco.', 'Use passos curtos e contínuos.', 'Ajuste a carga para preservar postura e progressão.'], attention: ['Não deixe o quadril subir excessivamente.', 'Reduza a carga se perder o controle da coluna.'], accent: 'from-orange-500/30', videoUrl: '/media/sled-push-technique.mp4' },
